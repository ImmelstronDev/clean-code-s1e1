...
var addButton=document.querySelector(".task__button_add");//first button
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.classList.add("task__input-checkbox");

    editInput.type="text";
    editInput.classList.add("task__input-text");

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.classList.add("button", "task__button_edit");

    deleteButton.classList.add("button", "task__button_delete");
    deleteButtonImg.src='./remove.svg';
    deleteButtonImg.alt='Delete task';
    deleteButtonImg.classList.add("button__img_delete");
